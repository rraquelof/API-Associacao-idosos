...
router.get("/acompanhamentos", authenticate, verifyCoordenador, verifyFamiliar, getAllAcompanhamentos);
router.get("/acompanhamento/:id", authenticate, verifyCoordenador, verifyFamiliar, getAcompanhamentosById);
